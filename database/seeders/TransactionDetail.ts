    ...
    await Database.table("transaction_details").multiInsert([
      {
        ...
        transaction_id: "34304c46-1bf2-4043-9c72-ea347952306f",
        item: "Panadol",
        cost: 50.25,
      },
      {
      ...
      },
      {
        ...
        transaction_id: "b4cdde94-d98d-4977-b2fc-f2cb2618061f",
        item: "Panadol",
        cost: 63.25,
      },
      {
      ...
      },
      {
        ...
        transaction_id: "9e984a66-6c8c-44ef-8595-5a762fcae18f",
        item: "Panadol",
        cost: 100.25,
      },
      {
